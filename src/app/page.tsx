...
const PRICE_FILTERS = {
  ...
  options: [
    ...
    { value: [0, 20], label: 'Under R$ 20,00' },
    { value: [0, 40], label: 'Any R$ 40,00' },
    // custom option 
  ]
} as const
    ...
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
        ...
        <div className="flex items-center">
          <DropdownMenu>
            <DropdownMenuTrigger className="group inline-flex justify-center text-sm font-medium text-gray-700
            hover:text-gray-900">
              Sort
                    ...
                    <li className="flex justify-center flex-col gap-2">
                      ...
                      <div className="flex justify-between">
                          ...
                          <div>
                            ...
                            {filter.price.isCustom 
                              ? maxPrice.toFixed(0) 
                              : filter.price.range[1].toFixed(0)} R$
                          </div>
                      </div>
                      <Slider 
                        className={cn({
